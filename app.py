...
try:
    ...
    st.warning("Dataset not found. Visualizations will be skipped.")
    df = pd.DataFrame()
...
if not df.empty:
    ...
    if all(col in df.columns for col in required_cols):
        ...
        st.warning("Required columns for visualizations not found.")
else:
    st.info("No dataset available for visualizations.")
